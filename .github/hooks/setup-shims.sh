...
# SessionStart hook for Claude AI environments: prepend shims directory to
# PATH so that bare python/pip/pipx/uv-pip invocations are intercepted with
# uv suggestions.  Requires CLAUDE_ENV_FILE to be set by the Claude runtime;
